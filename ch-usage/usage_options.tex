...
\begin{longtable}{p{0.3\linewidth} p{0.6\linewidth}}
  ...
  % Page footer
  \midrule
  \multicolumn{2}{r}{(Continued on next page)}\\ % chktex 36
  \endfoot
  ...
  \cmidrule[0.1pt](l{0.5em}r{0.5em}){1-2} % chktex 36 chktex 8
  ...
  \cmidrule[0.1pt](l{0.5em}r{0.5em}){1-2} % chktex 8 chktex 36
